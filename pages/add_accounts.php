...
require_once '../internal/add_admin_server.php';
...
# Retrieve Fullname in the database of admin
$stmt = $conn->prepare('SELECT first_name, last_name FROM admins WHERE admin_id = ?');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (addAdmin($admin_data)) {
        header('Location: ../pages/add_accounts.php');
        exit;
    } else {
        $form_errors = $_SESSION['form_error'] ?? [];
...
<body>
    ...
    <main class="content">
        ...
        <div class="card card-body border-0 shadow my-4">
            ...
            <form action="add_accounts.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                <div class="row">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">
                                <svg class="icon icon-xs" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" id="confirm_password" name="confirm_password" type="password" placeholder="Confirm the password" required>
                            <span class="input-group-text password-eye"
